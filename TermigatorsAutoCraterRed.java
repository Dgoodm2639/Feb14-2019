...
public class TermigatorsAutoCraterRed extends LinearOpMode {
...
//        while(rangeSensorFar.getDistance(DistanceUnit.CM) > 20) {
//            robot.moveLeft(0.5);
//        }

            robot.driveForwardEnc(.25,-800);

            robot.moveLeftEnc(.35, 1440*5);

            robot.turnClockwiseEnc(.35, 1200);

            robot.driveForwardEnc(.25, -1440*5);

            robot.markerLeft.setPosition(0.36);
            //sleep(5000);
            robot.markerLeft.setPosition(0.77);

            robot.driveForwardEnc(.7, 1440*10);
