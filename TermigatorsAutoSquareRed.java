...
@Autonomous
public class TermigatorsAutoSquareRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            robot.driveForwardEnc(0.25, 1440*2);
...
//        }
            ...
            robot.driveForwardEnc(.25,-720);

            robot.turnClockwiseEnc(.4, -1200);
            //robot.driveForwardEnc(.7,1440*3);
